...
<body>
 <%@ include file="header.jsp"%>
    <div class="container marketing">
      ...
      <form action="writeInfo" class="dropzone dz-clickable" enctype="multipart/form-data">
      Name of Album : <input type="text" name="album-name">
      Artist:<input type="text" name="artist-name">
      Cover:<input type="file" name="album-cover"><br>
