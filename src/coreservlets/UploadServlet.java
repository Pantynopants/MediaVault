...
//		System.out.println(System.getProperty("user.dir"));
		...
		try{
			...
			fileOut.close();
			out.println(saveFile + "upload successful.</p>");
			out.println(fileDir.getAbsolutePath());
			
//			System.out.println(checkFile.getAbsolutePath());
			String filetype = checkFile.getAbsolutePath().substring(checkFile.getAbsolutePath().lastIndexOf(".")+1);
			System.out.println(checkFile.getAbsolutePath());
			if (checkFile != null && filetype.equals("nfo")) {
				out.print("is nfo file");
				XMLUtil.readXML(checkFile.getAbsolutePath());
			}
			/*
